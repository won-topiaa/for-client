...
(function () {
  ...
  const DESCRIPTIONS = {
    ...
    head_shoulders:
      ...
      "여기서는 넥라인 부근까지 온(=지금 의미 있는) 형태만 보여줍니다.<br>" +
      "<b>자동 탈락:</b> ① 종가가 머리 위로 올라서면 패턴 무효(busted, Bulkowski 2005 — 이 경우 오히려 " +
      "상승으로 이어지는 경향) ② 넥라인 아래로 5% 넘게 하락이 진행되면 신호가 이미 소진된 것으로 보고 " +
      "제외 — 패턴의 정보력은 완성 직후에 집중된다는 실증(Lo·Mamaysky·Wang 2000)과 5% 룰(Bulkowski)에 " +
      "따른 것입니다. 되돌림(throwback)이 넥라인 부근까지 오는 경우가 약 3분의 2라 ±5~6% 밴드만 실전 유효 구간입니다." +
    ...
    inv_head_shoulders:
      ...
      "<b>자동 탈락:</b> ① 종가가 머리(최저점) 아래로 내려가면 패턴 무효(busted) ② 넥라인 위로 5% 넘게 " +
      "상승이 진행되면 진입 신호로서는 소진된 것으로 보고 제외합니다 (5% 룰 · 정보력은 완성 직후 집중)." +
      "<span class='src'>탈락 기준 출처: Bulkowski (2005) · Lo·Mamaysky·Wang (2000, Journal of Finance)</span>",
    cup_handle:
