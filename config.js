...
var DEFAULTS = {
  ...
  texts: {
    ...
    // 각 리워드 액션(실측 문구)
    attendance: ["출석하기"],                       // 14일 연속 출석
    timerCard:  ["20분마다"],                        // 타이머 카드
    adReward:   ["광고 보면 추가 보상", "광고 보면", "광고보고 추가 보상"],
    // 매일 광고 카드(하루 40개, 광고당 ~62P) — 카드로 식별 후 우측 '시청' 탭
    dailyAdCard: ["매일 광고를 시청", "오늘의 첫 시청", "시청하여 최대"],
    videoStart: ["시청하기"],                        // 영상 시청 카드
